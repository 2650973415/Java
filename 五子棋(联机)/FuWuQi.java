...
public class FuWuQi {
	...
	public static void main(String[] args) {
		...
		HashMap<String, String> fang = new HashMap<String, String>();//存放房间，key表示游戏房间号，value表示房间人数
		...
		try {
			...
			while(true){
				...
				new Thread(new FuWuRunnable(socket,fangID,map,fang)).start();
//				while(true){
//					String str = 0;
